            ...
            try:
                ...
                for condition in ["High", "Low"]:
                    ...
                    for q_index in questions_all: 
                        ...
                        #Yes_num = max(random.choice(list(range(max_Yes))), 1)
                        Yes_num = min(max_Yes, random.choice(list(range(1,4))))
                        No_num = 3-Yes_num
                        if q_index ==7:
                            Yes_num = Yes_total
                            No_num = No_total
                        ...
                        print([len(condition_materials[condition_materials.iloc[:, q_index+7]==1]), Yes_num,len(condition_materials[condition_materials.iloc[:, q_index+7]==1])>= Yes_num])

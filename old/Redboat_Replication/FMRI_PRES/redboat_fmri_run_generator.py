...
def create_redboat_fmri_run(subjn, condition_idx):
    ...
    material_COMP_1W = pd.read_csv(material_name)
    material_COMP_2W = pd.read_csv(material_name)
    material_LIST_1W = pd.read_csv(material_name)
    material_LIST_2W = pd.read_csv(material_name)
